...
本工程是USB摄像头门锁的一个demo，支持端（BK7258设备）到端（手机APP端）的演示。默认支持TCP/UDP/尚云进行网络传输。
...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    doorbell_4M与doorbell_8M的区别在于，前一个不支持DVP摄像头，还不支持板载mic，psram大小和型号也不一样。


.. figure:: ../../../../_static/doorbell_ab_4M_8M_different.png
    :align: center
    :alt: doorbell_4M_8M_different
    :figclass: align-center

    Figure 1. 4M & 8M的主要分区差异图

    从8M的PSRAM大小修改为4M的PSRAM大小，需要针对config文件进行修改，文件路径为：

    doorbell_4M/config/bk7258/config

    doorbell_4M/config/bk7258_cp1/config

    doorbell_4M/config/bk7258_cp2/config

    以下是 doorbell_8M 与doorbell_4M 主要的 config 参数区别（关键config但没有差异的，也会列出）：

     +------------------------------------+---------------------------------+------------------------------------+
     | project                            |        doorbell_8M              |          doorbell_cs2_ab_4M        |
     +------------------------------------+---------------------------------+------------------------------------+
...
.. figure:: ../../../../_static/decode_proc_4M.png
    :align: center
    :alt: 4M decode diagram
    :figclass: align-center

    Figure 2. doorbell_4M解码流程
...
,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
    ...
    共四笔提交，包括doorbell_4M的工程代码，代码目录核涉及文件如下表所示：
    ...
    |                                 |part_table.mk                                                            |
    +---------------------------------+-------------------------------------------------------------------------+
    |projects                         |media/doorbell_4M/CMakeLists.txt                                         |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258_cp1/config                               |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258_cp2/config                               |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258/ab_position_independent.csv              |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258/bk7258_partitions.csv                    |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258/config                                   |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258/configuration.json                       |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258/configurationab.json                     |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/bk7258/partitions.csv                           |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/config/ota_rbl.config                                  |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/main/app_main.c                                        |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/main/CMakeLists.txt                                    |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/main/Kconfig.projbuild                                 |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/main/vendor_flash.c                                    |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/main/vendor_flash_partition.h                          |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/pj_config.mk                                           |
    |                                 |                                                                         |
    |                                 |media/doorbell_4M/README.md                                              |
    +---------------------------------+-------------------------------------------------------------------------+
    ...
    +-------------------------------------------------------------------+-----------------------------------------------+
    |media/doorbell_4M/config/bk7258_cp1/config                         |增加doorbell_cs2_ab_4M工程CPU1使用的宏控       |
    |                                                                   |                                               |
    |tmedia/doorbell_4M/config/bk7258_cp2/config                        |增加doorbell_cs2_ab_4M工程CPU2使用的宏控       |
    |                                                                   |                                               |
    |media/doorbell_4M/config/bk7258/config                             |增加doorbell_cs2_ab_4M工程CPU0使用的宏控       |
    +-------------------------------------------------------------------+-----------------------------------------------+
