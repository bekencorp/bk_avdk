...
bk_err_t bk_rotate_deinit(void)
{
    ...
    if (check_software_rotate_task_is_open())
    {
        ...
        msg_send_req_to_media_major_mailbox_sync(EVENT_YUV_ROTATE_DEINIT_NOTIFY, MINOR_MODULE, 0, NULL);
    }
...
bk_err_t bk_rotate_init(media_rotate_mode_t rotate_mode)
{
    ...
    {
        msg_send_req_to_media_major_mailbox_sync(EVENT_YUV_ROTATE_INIT_NOTIFY, MINOR_MODULE, 0, NULL);
