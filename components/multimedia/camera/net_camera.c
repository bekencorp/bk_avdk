...
{
	.fb_init = frame_buffer_fb_init,
	.fb_deinit = frame_buffer_fb_deinit,
	.fb_clear = frame_buffer_fb_clear,
	.fb_complete = frame_buffer_fb_push,
	.fb_malloc = frame_buffer_fb_malloc,
	.fb_free = frame_buffer_fb_direct_free,
	.receive_jpeg = NULL,
};
...
bk_err_t bk_net_camera_open(media_camera_device_t *device)
{
	...
	net_camera_config.fb_init(FB_INDEX_JPEG);
