...
bk_err_t media_major_mailbox_init(void)
{
	...
	mb_chnl_ctrl(CP2_MB_CHNL_MEDIA, MB_CHNL_SET_RX_ISR, media_major_mailbox_mailbox_rx_isr);
	mb_chnl_ctrl(CP2_MB_CHNL_MEDIA, MB_CHNL_SET_TX_ISR, media_major_mailbox_mailbox_tx_isr);
	mb_chnl_ctrl(CP2_MB_CHNL_MEDIA, MB_CHNL_SET_TX_CMPL_ISR, media_major_mailbox_mailbox_tx_cmpl_isr);
