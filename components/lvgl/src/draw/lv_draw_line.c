...
void LV_ATTRIBUTE_FAST_MEM_L2 lv_draw_line_dsc_init(lv_draw_line_dsc_t * dsc)
{
...
void LV_ATTRIBUTE_FAST_MEM_L2 lv_draw_line(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_line_dsc_t * dsc,
                                        const lv_point_t * point1, const lv_point_t * point2)
{
