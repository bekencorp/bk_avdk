...
bk_err_t dual_device_transmission_udp_server_init(video_device_t *video_dev);

bk_err_t dual_device_transmission_udp_server_deinit(void);

bk_err_t dual_device_transmission_tcp_server_init(video_device_t *video_dev);
