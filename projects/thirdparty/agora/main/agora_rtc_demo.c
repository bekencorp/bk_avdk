...
void agora_main(void)
{
	...
	if (video_en) {
		...
		media_app_camera_open(&camera_device);	// PPI_320X240   PPI_640X480
		media_app_register_read_frame_callback(PIXEL_FMT_JPEG, app_media_read_frame_callback);
		memory_free_show();
	}
