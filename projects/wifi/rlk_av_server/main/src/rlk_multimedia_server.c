...
int rlk_mm_server_video_send_packet(uint8_t *data, uint32_t len, uint16_t *retry_cnt)
{
    int send_byte = 0;
    uint8_t *media_data;
...
int rlk_mm_server_voice_send_packet(uint8_t *data, uint32_t len, uint16_t *retry_cnt)
{
    int send_byte = 0;
    uint8_t *media_data;
    rlk_mm_pre_header_t *header = NULL;
